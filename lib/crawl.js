...
let urls = [];
let outfile = './sites.yml';

let filterSimilarBaseCount = {};
const filterSimilar = (url, limit) => {
    ...
    if (! (base in filterSimilarBaseCount)) {
        filterSimilarBaseCount[base] = 0;
    }

    return filterSimilarBaseCount[base]++ < limit;
}
